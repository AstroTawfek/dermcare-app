...
class NotificationScreen extends StatelessWidget {
  ...
  // Sample notification data — replace with real Firestore data later
  static const List<Map<String, dynamic>> _notifications = [
    {'icon': Icons.check_circle, 'color': 0xFF2E7D32, 'title': 'Appointment Confirmed',
     'body': 'Your appointment with Dr. Ayesha Rahman on Mon, 20 Jan is confirmed.',
     'time': '2 hours ago'},
    {'icon': Icons.alarm, 'color': 0xFFF57F17, 'title': 'Appointment Reminder',
     'body': 'You have an appointment tomorrow at 10:00 AM.',
     'time': 'Yesterday'},
    {'icon': Icons.person_add, 'color': 0xFF1565C0, 'title': 'New Doctor Available',
     'body': 'Dr. Md. Karim has joined DermCare and is now available.',
     'time': '3 days ago'},
    {'icon': Icons.cancel, 'color': 0xFFC62828, 'title': 'Appointment Cancelled',
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(n['body'] as String, style: const TextStyle(
                            fontSize: 13, color: AppColors.bodyText, height: 1.4)),
